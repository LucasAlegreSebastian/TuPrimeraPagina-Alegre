...
from . import views
from .views import PokemonCreateView, PokemonDetailView, PokemonUpdateView,EntrenadorUpdateView,PokebolaUpdateView,GimnasioUpdateView
...
urlpatterns = [
    ...
    path(
        "entrenadores/<int:pk>/editar/",
        EntrenadorUpdateView.as_view(),
    ...
    path(
        "gimnasios/<int:pk>/editar/",
        GimnasioUpdateView.as_view(),
        name="editar_gimnasio",
    ),  
    ...
    path(
        "pokebolas/<int:pk>/editar/",
        PokebolaUpdateView.as_view(),
        name="editar_pokebola",
    ),  
]
